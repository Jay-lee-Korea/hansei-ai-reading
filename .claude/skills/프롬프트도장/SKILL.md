...
2. **`[미선택]` 상태이면**:
   ...
   - 그 후 AskUserQuestion으로 선택받는다 (선지: 동굴의비유 / 논어_학이편 / 도덕경 / 니코마코스윤리학_제2권 / 성찰_제1_제2).
   - **선지 라벨 → 저장할 파일명 매핑** (Edit 시 반드시 아래 표에 따라 `*.txt` 확장자를 붙여 저장):
     ...
     | 논어_학이편 | `논어_학이편.txt` |
     | 도덕경 | `도덕경.txt` |
     | 니코마코스윤리학_제2권 | `니코마코스윤리학_제2권.txt` |
     | 성찰_제1_제2 | `성찰_제1_제2.txt` |
